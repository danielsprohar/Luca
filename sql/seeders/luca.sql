...
-- Since more than one person can occupy a parking space,
-- more than one person can make a payment on said parking space.
-- So, I want to know exactly who made the payment.
